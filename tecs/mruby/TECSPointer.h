 ...
 *   の責任を負わない．
 *  
 *   $Id: TECSPointer.h 1975 2013-06-16 07:34:59Z okuma-top $ 
 */
...
CHECK_AND_GET_POINTER_MOD_PROTO( SChar,  schar_t );	/* SChar pointer */
CHECK_AND_GET_POINTER_MOD_PROTO( UChar,  uchar_t );	/* UChar pointer */
